    ...
    .AddJwtBearer(options =>
    {
        options.TokenValidationParameters = new TokenValidationParameters
        {
            ...
            IssuerSigningKey = new SymmetricSecurityKey(
                Encoding.UTF8.GetBytes(builder.Configuration["Jwt:Secret"] ?? throw new ArgumentNullException("LỖI: Thiếu cấu hình Jwt:Secret trong file .env!"))),
            ClockSkew = TimeSpan.Zero // Loại bỏ độ trễ 5 phút mặc định
        };
    });
